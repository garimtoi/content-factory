...
**Version**: 2.5.0 | **Updated**: 2025-12-04 | **Context**: Windows 10/11, PowerShell, Root: `D:\AI\claude01`
...
4. **Inbox 체크**: ⚠️ **미검증** - Hook 구현됨, E2E 테스트 필요. (#60 참조)
...
> 전체 목록 (28개): `.claude/commands/` | 상세: `docs/WORKFLOW_REFERENCE.md`
